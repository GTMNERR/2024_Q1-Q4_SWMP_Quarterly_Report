...
Rainfall totals for the fourth quarter of 2024 are incomplete as a result of a program error. Data are missing beginning November 13, 2024 and continuing through the end of the year. Third quarter had the greatest quarterly rainfall totals (@fig-rainfall)due to September which had a very high monthly total (@fig-rainfall-2). September also had the greatest number of rain days exceeding 10 mm/day (@fig-rainfall-3) and more storms producing heavy rainfall (@fig-rainfall-4). 
...
September 2004 had the second highest monthly rainfall total recorded at the Pellicer Creek weather station (@tbl-topRain) and had the greatest amount of rainfall when compared to annual September data (@fig-SeptPrecip; @fig-SeptPrecip-1; @fig-SeptPrecip-2). Total rainfall in 2024 is 1347.2 mm which excludes the missing November and December rainfall totals  (@fig-SeptPrecip-3).

Light intensity remained high in July and August but decreased drastically in December. December had the lowest mid-day photosynthetically active radiation recorded (@fig-lightintensity). 

Daily average air temperatures were variable during the last half of the year similar to the first part of the year. January, March, November, and December experienced a few daily average air temperature extremes below and above the average range (@fig-range-atemp). 

While there were some low water temperatures throughout the year, daily water temperature averages were generally higher than average  (@fig-range-temp). Water temperature decreased in August and September with the onset of the large rain events and as a result water temperatures were below the historic average daily range at all four stations (@fig-range-temp-2; @fig-range-temp-3).Water temperatures increased at all four stations in November nearing the historic 2002-2024 maximum daily range (@fig-range-temp-1; @fig-range-temp-2; @fig-range-temp-3; @fig-range-temp-4).

Rainfall in the January and September through November brought salinity levels lower than their average daily ranges (@fig-range-sal), particularly at the stations farthest from the inlets (@fig-range-sal-1; @fig-range-sal-4). However, the drought conditions in spring made salinity levels rise. Salinity stayed above the average daily range at all stations through July but was most pronounced at Pine Island (@fig-range-sal-1). Salinity levels decreased to below the historic average daily range at all four stations in late August through November (@fig-range-sal-1; @fig-range-sal-2; @fig-range-sal-3; @fig-range-sal-4).
...
#|    - "Annual precipitation totals Jan 2002-Sept 2024."
#|    - "Annual precipitation totals Jan 2002-Sept 2024."
#| layout-ncol: 2
## September Precip ----
