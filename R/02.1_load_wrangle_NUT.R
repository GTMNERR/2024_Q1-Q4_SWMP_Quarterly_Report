...
nms <- names(read_excel(here::here('data',
                                   'swmp',
                                   # 'All_inclusive_NUT',
                                   'gtmnut2002-2024_QC_zeros-corrected.xlsx'), 
...
pi_nut <- subset(pi_nut_1, subset = '2024-10-01 0:00', operator = '<')
ss_nut <- subset(ss_nut_1, subset = '2024-10-01 0:00', operator = '<')
fm_nut <- subset(fm_nut_1, subset = '2024-10-01 0:00', operator = '<')
pc_nut <- subset(pc_nut_1, subset = '2024-10-01 0:00', operator = '<')
